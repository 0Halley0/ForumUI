    ...
    <div className="flex flex-col md:flex-row bg-background dark:bg-dark-background">
      ...
      <div className="flex-1">
        <div className="overflow-auto h-screen">
          <div>
            <h1 className="font-thin text-text dark:text-dark-text">Library</h1>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-0">
            {stories.map((story, index) => (
              <LibraryCard key={index} {...story} />
            ))}
          </div>
        </div>
      </div>
